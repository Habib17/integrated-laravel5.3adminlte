        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="active"><a aria-expanded="true" href="#fa-icons" data-toggle="tab">Font Awesome</a></li>
                    <li class=""><a aria-expanded="false" href="#glyphicons" data-toggle="tab">Glyphicons</a></li>
                </ul>
